...
class Promote(Action):
    def __init__(self, unit, new_class_nid):
        ...
        for stat_nid in DB.stats.keys():
            ...
            elif stat_value == -97:  # Add the difference between the new and old klass bases
                self.stat_changes[stat_nid] = abs(new_klass_bases.get(stat_nid, 0) - old_klass_bases.get(stat_nid, 0))
            else:
